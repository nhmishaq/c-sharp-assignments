...
namespace DbConnection
{
    public class DbConnector
    {
        ...
        static string db = "users"; //Change to your schema name
        ...
        //     // Query("SELECT idUsers, FirstName, LastName, FavoriteNumber FROM Users");

            
        //     // Execute ("INSERT INTO Users(FirstName, LastName, FavoriteNumber) VALUES ("Jamison", "Crowder", "80")");
        // }
    }
}